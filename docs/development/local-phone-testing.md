...
- [ ] 西班牙语即时切换：为继续不依赖地图的验收，返回首页，打开 Langue · Français，选择 Español 并点 Cerrar；核对首页 Idioma、Combustible / Recarga / Aire / Lavado 等界面文字。地图空白问题仍待查，不因转测语言而关闭；本次即时切换不代替重启后偏好保存或全页面三语验收。
