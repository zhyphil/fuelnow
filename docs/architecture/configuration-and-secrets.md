...
| Routing budget | `MAPBOX_MONTHLY_ELEMENT_BUDGET`, `MAPBOX_ELEMENTS_PER_SEARCH_MAX`, `ROUTE_CACHE_TTL_SECONDS` | Server config | Budget `0` disables paid routing; never exceed the approved hard cap |
