...
| `fr-qualicharge-irve` | validating | FR / Charge static + dynamic | DGEC / QualiCharge | IRVE open data from connected operators | Dataset page declares Licence Ouverte 2.0; detailed reuse review pending | Static file validated 2026-09-04: 78,089/78,114 unique PDC IDs already occur in PAN and must not be unioned; dynamic availability/price validation is next |
