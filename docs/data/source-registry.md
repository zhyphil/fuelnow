...
| `es-miteco-ripree` | validating | ES / Charge static | MITECO | Puntos de Recarga de Vehículos Eléctricos (RIPREE) | MITECO open-data legal notice permits commercial reuse, adaptation and combination with origin, update, non-endorsement and metadata conditions; consolidated review pending | Official national export selected 2026-09-04: 43,610 connector rows, 36,465 PDCs and 12,214 installations; no availability or tariff fields; see [static source validation](./spain-ev-static-source.md) |
| `es-ree-reve` | validating | ES / Charge availability + tariffs | Red Eléctrica de España | Reve / Sistema de Gestión y Visualización (SGV) | Public API access and downstream reuse terms require approval/review | Reve reports dynamic OCPI data for 42,800/44,631 EVSEs (95.90%) and its price filter matches 13,323/14,564 locations (91.48%); production is blocked by API-key approval, five calls/hour, individual exact-status reads and pending RIPREE reconciliation; see [dynamic review](./spain-ev-dynamic-coverage.md) |
