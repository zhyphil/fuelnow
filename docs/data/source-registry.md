...
| `es-miteco-fuel` | approved for development | ES / Fuel, Air, Wash | MITECO | Instalaciones de suministro de combustibles a vehículos y embarcaciones con venta pública | Modern distributions report CC BY 4.0: commercial reuse, caching, adaptation, and redistribution permitted with attribution, licence/material links, and change indication | Endpoints verified 2026-09-03; follow [licence review](./spain-fuel-licence.md); final legal review must resolve legacy non-alteration wording before public Beta |
