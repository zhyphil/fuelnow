...
| `es-miteco-fuel` | validating | ES / Fuel, Air, Wash | MITECO | Instalaciones de suministro de combustibles a vehículos y embarcaciones con venta pública | Modern catalogue reports CC BY 4.0; formal verification pending P1-ES-02 | Current national REST JSON (11,475 records), Madrid/Barcelona filters, reference lists, and XLS snapshot verified reachable on 2026-09-03; see [source investigation](./spain-fuel-source.md) |
