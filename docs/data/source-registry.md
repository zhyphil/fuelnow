...
| `es-miteco-fuel-prices` | approved for development | ES / Fuel | MITECO | Instalaciones de suministro de combustibles a vehículos y embarcaciones con venta pública | Modern distributions report CC BY 4.0: commercial reuse, caching, adaptation, and redistribution permitted with attribution, licence/material links, and change indication | Canonical ID aligned with the adapter on 2026-09-04; endpoints verified 2026-09-03; follow [licence review](./spain-fuel-licence.md); Air/Wash fields are unavailable; final legal review must resolve legacy non-alteration wording before public Beta |
