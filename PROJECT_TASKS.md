...
> 下一项任务：两台手机浏览器后端均可达；华为已安装 Expo Go、打开项目并看到 DEMO 站点，下一步验收 Fuel 详情和模拟导航保护，再逐项测试其余功能。iPhone App 安装仍待处理；华为底层 Android 版本未显示，暂留空。发布与真实 Beta 条件仍未关闭，见 [真机测试说明](./docs/development/local-phone-testing.md)
> 最后更新：2026-09-07
